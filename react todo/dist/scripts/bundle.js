...
var ListTodoItem = React.createClass({displayName: "ListTodoItem",
	render: function () {
		var defaultClass = 'list-group-item';
		defaultClass += this.props.done ? ' list-group-item-success' : ' list-group-item-warning';
		
		return (
			React.createElement("li", {className: defaultClass, 
				onClick: this.props.changeTodo, 
				onDoubleClick: this.props.editTodo}, 
				React.createElement("span", {className: "badge", onClick: this.props.removeTodo}, "×"), 
				this.props.value
			)
		);
	}
...
var TodoApp = React.createClass({displayName: "TodoApp",
	...
	render: function () {
		var todos = this.state.todos.map(function (item, i) {
			return (React.createElement(ListTodoItem, {
				value: item.value, 
				done: item.done, 
		...
		return (
			React.createElement("div", {className: "container-fluid"}, 
				React.createElement("div", {className: "col-md-4"}, 
					React.createElement("h1", null, "Todo React example"), 
					React.createElement("div", {className: "input-group"}, 
						React.createElement("label", {htmlFor: "todoInput"}), 
...
},{"./listTodoItems":157,"react":156}],159:[function(require,module,exports){
'use strict';
...
},{"./components/todoApp":158,"react":156}]},{},[159]);
